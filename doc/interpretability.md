...
The computational complexity inherent in these architectures—driven by high-dimensional feature spaces and neural depth—rendered the full suite of interpretability methods prohibitive within our operational timeframe. Initial attempts to deploy global attribution methods demonstrated that per-instance processing times exceeded the hardware’s practical capacity. To mitigate this, we implemented a strategic undersampling approach (approx. 100 instances); however, this failed to yield stable results. We hypothesize that the high density and variance of the training data required a larger representative sample than our computational resources could sustain, leading to a failure in convergence for the explainability algorithms.